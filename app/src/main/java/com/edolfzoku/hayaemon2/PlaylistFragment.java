...
public class PlaylistFragment extends Fragment implements View.OnClickListener, View.OnLongClickListener {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        for(int i = 0; i < arSongs.size(); i++) {
                            ...
                            if(!(uri.getScheme() != null && uri.getScheme().equals("content"))) {
                                File file = new File(song.getPath());
                                if (file != null && file.getParent() != null && file.getParent().equals(sActivity.getFilesDir().toString())) {
                                    if (!file.delete()) System.out.println("ファイルが削除できませんでした");
                                }
                            }
                        }
    ...
    static void setSavingEffect() {
        ...
        saver.setTimeOmIncreaseSpeed(EffectFragment.sTimeOfIncreaseSpeedSpecified);
        saver.setIncreaseSpeed(EffectFragment.sIncreaseSpeedSpecified);
        saver.setIncreaseSpeedLoop(EffectFragment.sIncreaseSpeedLoop);
        saver.setTimeOmDecreaseSpeed(EffectFragment.sTimeOfDecreaseSpeedSpecified);
        saver.setDecreaseSpeed(EffectFragment.sDecreaseSpeedSpecified);
        saver.setDecreaseSpeedLoop(EffectFragment.sDecreaseSpeedLoop);
        saver.setTimeOfRaisePitch(EffectFragment.sTimeOfRaisePitchSpecified);
        saver.setRaisePitch(EffectFragment.sRaisePitchSpecified);
        saver.setRaisePitchLoop(EffectFragment.sRaisePitchLoop);
    ...
    private static void restoreEffect() {
        ...
        EffectFragment.setRaisePitchSpecified(saver.getRaisePitch());
        EffectFragment.setRaisePitchLoop(saver.getRaisePitchLoop());
        EffectFragment.setTimeOfLowerPitch(saver.getTimeOfLowerPitch());
        EffectFragment.setLowerPitchSpecified(saver.getLowerPitch());
        EffectFragment.setLowerPitchLoop(saver.getLowerPitchLoop());
    ...
    private boolean hasActiveEffectOrEq() {
    ...
    private void saveSong(int nPurpose, String strFileName) {
        ...
        String strPath = item.getPath();
        if (nPurpose != 1 || hasActiveEffectOrEq()) {
            int _hTempStream;
            ...
            finishExportWithUri(0, 0, Uri.parse(item.getPath()), alertDialog);
        }
    }
    ...
    void finishExportWithFilePath(int hTempStream, int hEncode, String strPathTo, AlertDialog alert) {
        if(alert.isShowing()) alert.dismiss();
    ...
    void finishExportWithUri(int hTempStream, int hEncode, Uri uri, AlertDialog alert) {
        if(alert.isShowing()) alert.dismiss();
...
//
//        ArrayList<SongItem> arSongs = sPlaylists.get(sSelectedPlaylist);
//        ArrayList<SongItem> selectedSongs = new ArrayList<>();
//        for (SongItem songItem : arSongs) {
