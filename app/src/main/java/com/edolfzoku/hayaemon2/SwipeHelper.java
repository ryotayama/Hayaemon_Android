...
public abstract class SwipeHelper extends ItemTouchHelper.SimpleCallback {
    ...
    private static List<UnderlayButton> buttons;
    private static GestureDetector gestureDetector;
    static int swipedPos = -1;
    private float swipeThreshold = 0.5f;
    private static Map<Integer, List<UnderlayButton>> buttonsBuffer;
    static Queue<Integer> recoverQueue;
    ...
    private View.OnTouchListener onTouchListener = new View.OnTouchListener() {
        ...
        public boolean onTouch(View view, MotionEvent e) {
            ...
            if (e.getAction() == MotionEvent.ACTION_DOWN || e.getAction() == MotionEvent.ACTION_UP ||e.getAction() == MotionEvent.ACTION_MOVE) {
                if (rect.top < point.y && point.y < rect.bottom) gestureDetector.onTouchEvent(e);
                else {
    ...
    public void onSwiped(RecyclerView.ViewHolder viewHolder, int direction) {
        swipe(viewHolder.getAdapterPosition());
    }
    ...
    public void swipe(int pos) {
        ...
        buttonsBuffer.clear();
        swipeThreshold = 0.5f * buttons.size() * BUTTON_WIDTH * Resources.getSystem().getDisplayMetrics().density;
        recoverSwipedItem();
    }
    ...
    public void onChildDraw(Canvas c, RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder, float dX, float dY, int actionState, boolean isCurrentlyActive) {
        ...
        if(actionState == ItemTouchHelper.ACTION_STATE_SWIPE){
            if(dX < 0) {
                ...
                else buffer = buttonsBuffer.get(pos);

                translationX = dX * buffer.size() * BUTTON_WIDTH * Resources.getSystem().getDisplayMetrics().density / itemView.getWidth();
